...
cursor.execute("CREATE DATABASE IF NOT EXISTS BIS698M_GRP5")
cursor.execute("USE BIS698M_GRP5")
...
class votingsystem:
    ...
    def loginscreen(self):
        ...
        self.bg = Image.open("images/login screen image.png")
        ...
        self.login_button = ctk.CTkButton(
            ...
            fg_color="#244363",  # Button background color
            text_color="white",
            border_width=1,
            border_color='black',
    ...
    def signupscreen(self):
        ...
        self.bg = Image.open("images/register.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        self.email_entry = Entry(self.signup_frame, font=("calibri", 15), bg="#fffcf5", fg="grey")
        ...
        # Password entry with default text
        self.password_entry = Entry(self.signup_frame, font=("calibri", 15), bg="#fffcf5", fg="grey", show="", width=30)
        self.password_entry.place(x=650, y=420)
        self.password_entry.insert(0, "8+ characters with Mixed Case & Numbers")
        # Bind focus events
        self.password_entry.bind('<FocusIn>', self.pass_on_focus_in)
        self.password_entry.bind('<FocusOut>', self.pass_on_focus_out)
        ...
        # Confirm Password entry with default hint text
        self.confirm_password_entry = Entry(self.signup_frame, font=("calibri", 15), bg="#fffcf5", fg="grey", show="", width=30)
        ...
        self.confirm_password_entry.bind('<FocusIn>', self.confirm_pass_on_focus_in)
        self.confirm_password_entry.bind('<FocusOut>', self.confirm_pass_on_focus_out)
        ...
        self.show_pass.place(x=970, y=480)
    ...
    def pass_on_focus_in(self, event):
        # If the default text is shown, clear it and hide the characters with "*"
        if self.password_entry.get() == "8+ characters with Mixed Case & Numbers":
    ...
    # Method for focus-in event on confirm password entry
    def confirm_pass_on_focus_in(self, event):
        # If the default text is shown, clear it and hide the characters with "*"
    ...
    def confirm_pass_on_focus_out(self, event):
        # If the entry is empty, show the default text again and remove the mask
    ...
    def login_authentication(self):
        ...
        cursor = voting_systemdb.cursor()
        select_data = f"SELECT * FROM voter WHERE BINARY email = '{self.email}' AND BINARY password = '{self.password}'"
    ...
    def voter_screen(self):
        ...
        self.bg = Image.open("images/Userdashboard.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        self.voter_label.place(x=740, y=100)

        # Add vote image button
        self.vote_image = Image.open("images/vote.png")
        ...
        self.view_result_image = Image.open("images/voting-results.png")
        ...
        self.logout_image = Image.open("images/user_logout.png")
    ...
    def forgot_password(self):
        ...
        self.bg = Image.open("images/forgot_password.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
    ...
    def admin_screen(self):
        ...
        #add admin image
        self.bg = Image.open("images/admin.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        self.create_elction = Image.open("images/create_election.png")
        ...
        self.create_candidate = Image.open("images/create_candidate.png")
        ...
        self.create_party = Image.open("images/party.png")
        ...
        self.view_election = Image.open("images/view_elections.png")
        ...
        self.view_result = Image.open("images/view_results.png")
        ...
        self.ballot = Image.open("images/ballo-box.png")
        ...
        self.result = Image.open("images/reports.png")
        ...
        self.delete_elction = Image.open("images/delete_election.png")
        ...
        self.logout = Image.open("images/logout.jpeg")
    ...
    def create_election(self):
        ...
        self.bg = Image.open("images/election.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        # Add Election start date label and DateEntry widget to the left side of the page
        self.election_start_date_label = Label(
            self.create_election_frame, 
        ...
        # Replace Entry with DateEntry for a calendar popup
        self.election_start_date_entry = DateEntry(
            self.create_election_frame, 
            font=("calibri", 15), 
            bg="#003D60", 
            fg="black",
            date_pattern="yyyy-mm-dd"  # Set the date format
        )
        ...
        # Add Election end date label and DateEntry widget to the right side of the start date entry box
        self.election_end_date_label = Label(
            self.create_election_frame, 
            text="Election End Date", 
            font=("calibri", 15, "bold"), 
            bg="#003d60", 
            fg="white"
        )
        ...
        # Replace Entry with DateEntry for a calendar popup for the end date
        self.election_end_date_entry = DateEntry(
            self.create_election_frame, 
            font=("calibri", 15), 
            bg="#003d60", 
            fg="white",
    ...
    def register_election(self):
        ...
        description = self.election_description_entry.get("1.0", "end-1c")  # Use correct method for Text widget
        ...
        # if election already exists show error
        cursor = voting_systemdb.cursor()
    ...
    def create_candidate_screen(self):
        ...
        self.bg = Image.open("images/candidate.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
...
# Add candidate gender radio buttons
        ...
        self.candidate_gender_label = Label(
            self.create_candidate_frame,
            text="Gender",
            font=("calibri", 15, "bold"),
            bg="#0C2452",
            fg="white"
        ...
        # Common configuration for radio buttons
        radio_button_config = {
            "variable": self.gender_var,
            "font": ("calibri", 15),
            "bg": "#0C2452",
            "fg": "white",
            "selectcolor": "black"  # Use a distinct color for the selected state
        }

        # Add male gender radio button (with circular indicator)
        self.male_radio = Radiobutton(
            self.create_candidate_frame,
            text="Male",
            value="Male",
            **radio_button_config
        ...
        # Set default value (optional, ensures one is selected)
        self.gender_var.set("")
    ...
    def register_candidate(self):
        ...
        if not age.isdigit():
            messagebox.showerror("Error", "Age must contain only numbers")
            return

        if not re.match(r"^[0-9]{5}$",zip_code):
            messagebox.showerror(title="Invalid Zip Code",message="Zip code should only contains 5 Digits")
            return

        if not re.match(r"^[0-9]{10}$",phone_number):
            messagebox.showerror(title="Invalid Phone Number",message="Phone Number should only contains 10 Digits")
            return
    ...
    def view_election_screen(self):
        ...
        # Create headings for the election details (once)
        ...
        election_start_date_heading.place(x=300, y=120)
        
        election_end_date_heading = Label(self.view_election_frame, text="End Date", font=("calibri", 15, "bold"), bg="#15196e", fg="white")
        election_end_date_heading.place(x=500, y=120)
        
        election_description_heading = Label(self.view_election_frame, text="Description", font=("calibri", 15, "bold"), bg="#15196e", fg="white")
        election_description_heading.place(x=700, y=120)
        
        # Display the election details from the database
        y_position = 150  # Starting position for the first row
        for i, election in enumerate(elections):
            # Create row fields
            election_name = Label(self.view_election_frame, text=election[0], font=("calibri", 13), bg="#15196E", fg="white")
            election_name.place(x=50, y=y_position)
            
            start_date = Label(self.view_election_frame, text=election[1], font=("calibri", 13), bg="#15196E", fg="white")
            start_date.place(x=300, y=y_position)
            
            end_date = Label(self.view_election_frame, text=election[2], font=("calibri", 13), bg="#15196E", fg="white")
            end_date.place(x=500, y=y_position)
            
            # Dynamically adjust y_position based on description length
            description_label = Label(self.view_election_frame, text=election[3], font=("calibri", 13), bg="#15196E", fg="white", wraplength=400, justify="left")
            description_label.place(x=700, y=y_position)
            
            # Calculate row height based on description length
            row_height = max(30, (len(election[3]) // 50) * 20 + 30)  # Ensure minimum height of 30
            y_position += row_height  # Move to the next row position
        
        # Add back to admin button to the bottom of the page
        ...
        self.back_button.place(x=1000, y=680)
    ...
    def delete_election_data(self):
        ...
        if election_name == "Select Election":
            messagebox.showerror("Error", "Please select a valid election to delete.")
            return

        try:
            cursor = voting_systemdb.cursor()

            # Fetch the election_id of the selected election
            select_election_id = "SELECT election_id FROM election WHERE election_name = %s"
            cursor.execute(select_election_id, (election_name,))
            election_id = cursor.fetchone()

            if election_id:
                # Step 1: Delete from the `vote` table
                delete_votes = """
                    DELETE v 
                    FROM vote v
                    JOIN ballot_box b ON v.ballot_box_id = b.ballot_box_id
                    WHERE b.election_id = %s
                """
                cursor.execute(delete_votes, (election_id[0],))

                # Step 2: Delete from the `ballot_box` table
                delete_ballot_box = "DELETE FROM ballot_box WHERE election_id = %s"
                cursor.execute(delete_ballot_box, (election_id[0],))

                # Step 3: Delete from the `election` table
                delete_election = "DELETE FROM election WHERE election_id = %s"
                cursor.execute(delete_election, (election_id[0],))

                voting_systemdb.commit()
                messagebox.showinfo("Success", f"Election '{election_name}' deleted successfully.")
            else:
                messagebox.showerror("Error", "Election not found.")
        except Exception as e:
            print("Error deleting election:", e)
            voting_systemdb.rollback()
            messagebox.showerror("Error", "Failed to delete the election.")    
    ...
    def vote_screen(self):
        ...
        self.bg = Image.open("images/user_election_screen.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        self.next_image = Image.open("images/next_user_election_screen.png")
        ...
        self.back_image = Image.open("images/back.png")
    ...
    def report_screen(self):
        ...
        self.bg = Image.open("images/reportsscreen.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        self.bg_image = Label(self.report_frame, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)
            
        # Add report title and timestamp
        self.report_label = Label(self.report_frame, text="Report", font=("calibri", 30, "bold"), bg="#EAEAEA", fg="black")
        self.report_label.place(x=550, y=80)
        
        current_timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        timestamp_label = Label(self.report_frame, text=f"Generated on: {current_timestamp}", font=("calibri", 15), bg="#EAEAEA", fg="black")
        timestamp_label.place(x=450, y=150)
        
   
        style = ttk.Style()
        style.theme_use("clam")
        style.configure("Treeview", background="#EAEAEA", foreground="white", fieldbackground="#EAEAEA")
        style.map("Treeview", background=[('selected', 'green')])
        self.report_tree = ttk.Treeview(root)
        # Create a treeview with custom style
        self.report_tree = ttk.Treeview(self.report_frame, columns=("Election Name", "Candidate Name", "Votes"), show="headings", height=15)
        self.report_tree.heading("Election Name", text="Election Name")
        self.report_tree.heading("Candidate Name", text="Candidate Name")
        self.report_tree.heading("Votes", text="Votes")
        self.report_tree.column("Election Name", width=200)
        self.report_tree.column("Candidate Name", width=200)
        self.report_tree.column("Votes", width=100)
        self.report_tree.place(x=120, y=240)
        
        # Define a tag for the row background color
        self.report_tree.tag_configure('row_background', background="#EAEAEA", foreground="black")

        # Insert the fetched votes into the treeview with the background tag
        cursor = voting_systemdb.cursor()
        select_data = """
        ...
        for vote in votes:
            self.report_tree.insert("", "end", values=vote, tags=('row_background',))
        
        # Add download report image button
        self.download_image = Image.open("images/download.png")
        self.download_image = self.download_image.resize((70, 70), Image.LANCZOS)
        self.download_image = ImageTk.PhotoImage(self.download_image)
        self.download_button = Button(self.report_frame, image=self.download_image, bg="#EAEAEA", bd=0, cursor="hand2", command=self.download_report)
        ...
        self.back_image = self.back_image.resize((70, 70), Image.LANCZOS)
        self.back_image = ImageTk.PhotoImage(self.back_image)
        self.back_button = Button(self.report_frame, image=self.back_image, bg="#EAEAEA", bd=0, cursor="hand2", command=self.admin_screen)
    ...
    def download_report(self):
        try:
            # Generate a report for the election results from the database
            cursor = voting_systemdb.cursor()
            select_data = """
                SELECT election_name, candidate_name, votes 
                FROM (
            ...
            if not votes:
                messagebox.showinfo("Info", "No data available for the report.")
                return

            # Automatically generate a filename with a timestamp
            current_timestamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
            filename = f"election_results_{current_timestamp}.pdf"
            ...
            # Write the title centered at the top
            ...
            # Write the timestamp below the title
            pdf.setFont("Helvetica", 12)
            timestamp_text = f"Report generated on: {current_timestamp}"
            timestamp_width = pdf.stringWidth(timestamp_text, "Helvetica", 12)
            pdf.drawString((width - timestamp_width) / 2, y_position, timestamp_text)
            y_position -= 30  # Move down
            
            # Write the header row
            pdf.setFont("Helvetica-Bold", 12)
            pdf.drawString(50, y_position, "Election Name")  # Left-aligned
            
            # Center-align "Candidate Name" heading
            candidate_heading = "Candidate Name"
            candidate_heading_width = pdf.stringWidth(candidate_heading, "Helvetica-Bold", 12)
            candidate_heading_x = 200 + (250 - candidate_heading_width) / 2  # Center within the column
            pdf.drawString(candidate_heading_x, y_position, candidate_heading)
            
            pdf.drawString(450, y_position, "Votes")  # Left-aligned for Votes
            y_position -= 20  # Move down
            
            pdf.setFont("Helvetica", 10)
            
            # Write the data
            for election_name, candidate_name, votes_count in votes:
                ...
                # Draw Election Name
                pdf.drawString(50, y_position, str(election_name))
                
                # Center Candidate Name
                candidate_text_width = pdf.stringWidth(candidate_name, "Helvetica", 10)
                candidate_center_x = 200 + (250 - candidate_text_width) / 2  # Center within the column
                pdf.drawString(candidate_center_x, y_position, str(candidate_name))
                
                # Draw Votes
                pdf.drawString(450, y_position, str(votes_count))
                y_position -= 20  # Move down
    ...
    def show_candidates(self):
        ...
        #add image to the vote page
        self.bg = Image.open("images/user_vote_candiate_Screen.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        self.bg_image = Label(self.vote_frame, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)
    ...
    def view_result_screen(self):
        ...
        self.bg = Image.open("images/view_results_screen.png")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        ...
        self.view_result_image = Image.open("images/resultstext.png")
        ...
        self.election_image = Image.open("images/user_election_page.png")
        ...
        self.show_result_image = Image.open("images/user_show_results.png")
    ...
    def show_result(self):
        for i in self.view_result_frame.winfo_children():
            i.destroy()
        #add image to the view result page
        self.bg = Image.open("images/user_view_results_screen.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
        self.bg_image = Label(self.view_result_frame, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)
        ...
        self.election_image = Image.open("images/user_winning_page.png")
        self.election_image = self.election_image.resize((60, 60), Image.LANCZOS)
        self.election_image = ImageTk.PhotoImage(self.election_image)
    ...
    def register_party(self):
        ...
        self.bg = Image.open("images/create_party.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
    ...
    def ballot_box(self):
            ...
            self.bg = Image.open("images/ballot_screen.png")
            self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
            self.bg = ImageTk.PhotoImage(self.bg)
    ...
    def admin_view_result(self):
        ...
        #add image to the view result page
        self.bg = Image.open("images/election_results.jpg")
        self.bg = self.bg.resize((1200, 750), Image.LANCZOS)
        self.bg = ImageTk.PhotoImage(self.bg)
...
def centre_window(root_window):
    root_window.withdraw()  # Hide the window while setting dimensions
    root_window.update_idletasks()  # Update geometry information
    screen_width = root_window.winfo_screenwidth()
    screen_height = root_window.winfo_screenheight()
    x = 140
    y = 20
    root_window.geometry(f"+{x}+{y}")  # Set the position
    root_window.deiconify()  # Show the window
...
if __name__ == "__main__":
    root = Tk()
    centre_window(root)  # Center the window on the screen
